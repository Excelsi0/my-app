...
- Время проверки (UTC): `2026-08-08T19:36:51.720255Z`
- Режим: `live API`
...
| --- | --- | ---: | --- | ---: | ---: |
| finance1 | https://cpa-server-vtel.onrender.com/api/finance1 | 200 | application/json; charset=utf-8 | 627 ms | 465 B |
| finance2 | https://cpa-server-vtel.onrender.com/api/finance2 | 200 | application/json; charset=utf-8 | 948 ms | 91 B |
| rates | https://api.currencyfreaks.com/v2.0/rates/latest?apikey=REDACTED | 200 | application/json | 3350 ms | 26251 B |
